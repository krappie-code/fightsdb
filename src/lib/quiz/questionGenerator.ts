...
const MOCK_FIGHTS = [
  ...
  // April 28, 2026 event - UFC Fight Night: Della Maddalene vs Prates (Perth)
  {
    id: '31',
    event: { name: 'UFC Fight Night: Della Maddalene vs. Prates', date: '2026-04-28', location: 'Perth, Australia' },
    fighter1: { name: 'Carlos Prates', nickname: '' },
  ...
  },
  {
    id: '32',
    event: { name: 'UFC Fight Night: Della Maddalene vs. Prates', date: '2026-04-28', location: 'Perth, Australia' },
    fighter1: { name: 'Steve Erceg', nickname: 'Astro Boy' },
    fighter2: { name: 'Kai Kara-France', nickname: 'Don\'t Blink' },
    result: 'Win',
    method: 'Decision',
    round: 3,
    time: '5:00',
  ...
  },
  {
    id: '33',
    event: { name: 'UFC Fight Night: Della Maddalene vs. Prates', date: '2026-04-28', location: 'Perth, Australia' },
    fighter1: { name: 'Jimmy Crute', nickname: 'The Brute' },
    fighter2: { name: 'Alonzo Menifield', nickname: 'Atomic' },
    result: 'Win',
    method: 'Decision',
    round: 3,
    time: '5:00',
  ...
  },
  {
    id: '34',
    event: { name: 'UFC Fight Night: Della Maddalene vs. Prates', date: '2026-04-28', location: 'Perth, Australia' },
    fighter1: { name: 'Casey O\'Neill', nickname: 'King Casey' },
    fighter2: { name: 'Luana Santos', nickname: '' },
    result: 'Win',
    method: 'Decision',
    round: 3,
    time: '5:00',
  ...
  },
  {
    ...
    fighter2: { name: 'Alex Reyes', nickname: '' },
    result: 'Win',
    method: 'Submission',
    round: 1,
    time: '4:12',
